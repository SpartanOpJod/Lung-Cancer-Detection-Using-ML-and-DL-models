...
IMG_SIZE = 224
BATCH_SIZE = 8  # Reduced from 16 for better convergence
EPOCHS = 30
...
def build_model(num_classes):
    # using a moderately sized Swin model; switch name if you want smaller/larger
