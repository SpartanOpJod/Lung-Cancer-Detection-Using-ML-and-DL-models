Hey guys , This is my Final year project in which we took the dataset : https://www.kaggle.com/datasets/mohamedhanyyy/chest-ctscan-images
As the First step In this project I perform data augmentation using on the fly model to augment the the data.
